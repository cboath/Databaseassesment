<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Frontend.Master" CodeBehind="Movielist.aspx.vb" Inherits="Databaseassesment.Movielist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="content">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="Selectmoviegen" SelectCommandType="StoredProcedure" 
            InsertCommand="insertmovie" InsertCommandType="StoredProcedure" 
            UpdateCommand="updatemov" UpdateCommandType="StoredProcedure" 
            DeleteCommand="deletemovie" DeleteCommandType="StoredProcedure">
            <DeleteParameters>
